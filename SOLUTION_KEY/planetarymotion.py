...
TIME = 20.0*YR  # How many days to run the simulation?
...
planets = [
    make_planet(name="Sol", a=0.0*AU, e=0.0, color="gold"),

    # INNER PLANETS
    make_planet(name="Mercury", a=0.3871*AU, e=0.206, color="gray"),
    make_planet(name="Venus", a=0.7233*AU, e=0.007, color="purple"),
    make_planet(name="Earth", a=1.000*AU, e=0.017, color="green"),
    make_planet(name="Mars", a=1.5273*AU, e=0.093, color="red"),

    # ASTEROID BELT
    make_planet(name="Ceres", a=2.76593*AU, e=0.0798, color="black"),

    # OUTER PLANETS
    make_planet(name="Jupiter", a=5.2028*AU, e=0.048, color="magenta"),
    make_planet(name="Saturn", a=9.5388*AU, e=0.056, color="beige"),
    make_planet(name="Uranus", a=19.1914*AU, e=0.046, color="blue"),
    make_planet(name="Neptune", a=30.0611*AU, e=0.010, color="cyan"),
]
